    ...
    <div class="footer-top">
        <div class="container">
            ...
            <div class="col-lg-2 col-md-6 footer-links">
                ...
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('welcome') }}/#about">About</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('welcome') }}/#ourservices">Services</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('faqs') }}">FAQs</a></li>
                <li><i class="bx bx-chevron-right"></i> <a href="{{ route('welcome') }}/#gallery">Gallery</a></li>
                </ul>
            </div>
